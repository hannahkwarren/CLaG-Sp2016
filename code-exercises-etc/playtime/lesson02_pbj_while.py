...
while True:
    try:
        slices_bread = (int(raw_input("How many slices of bread do you have?")))
        ...
        print "Oops!  That was not a valid number/integer.  Try again..."
...
if peanut_butter >= 1 and slices_bread >= 2 and jelly >= 1:
    ...
    error_messages.append("Out of peanut butter. Sad. :(") 
elif slices_bread <= 1:
    error_messages.append("Out of bread. Oh no!")
elif jelly == 0:
    error_messages.append("No more jelly. Try just a PB sandwich!")
else:
    print "Can't make a sandwich at all, silly."
